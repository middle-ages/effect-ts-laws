...
\newcommand{\EqOf}       [1] {\Type{Equivalence}\Br{#1}}

\newcommand{\ArbT}       [1] {\ArbOf{\,\Type{#1}\,}}
\newcommand{\ArbP}       [1] {\ArbOf{\Ge{#1}}}
\newcommand{\EqP}        [1] {\EqOf{\Ge{#1}}}
...
\newcommand{\Option}     [1] {\Type{Option}\Tp{#1}}
\newcommand{\Either}     [2] {\Type{Either}\Tpp{#1}{#2}}
\newcommand{\Var}        [2] {\textit{#1} \Co \Type{#2}}

\newcommand{\OptionA}        {\Option{A}}

\newcommand{\fnab}           {\ensuremath{(\X\Var{a}{\Ge{A}})\XX\Ar\XX\Ge{B}\a}}
\newcommand{\fnaa}           {\ensuremath{(\x\Var{a}{\Ge{A}})\XX\Ar\XX\Ge{A}\a}}
...
\newcommand{\fnabc}          {\ensuremath{(\x\Var{a}\A{\Ge{A}}, \Var{b}{\Ge{B}})\XX\Ar\XXX\Ge{C}}}
